...
export class SidebarComponent {
  ...
  navItems: NavItem[] = [
    { id: 'dashboard', label: 'Dashboard', icon: 'chart', active: true },
    { id: 'users', label: 'Team Members', icon: 'users', active: false },
    { id: 'applications', label: 'Applications', icon: 'apps', active: false },
    { id: 'verifications', label: 'Verifications', icon: 'shield', active: false },
    { id: 'compliance', label: 'Compliance', icon: 'file', active: false },
