...
import { Shield, Mail, Lock, User, Eye, EyeOff, ArrowRight, Sparkles, ArrowLeft } from 'lucide-react';
...
const SignupAdminPage = ({ onLogin }: SignupAdminPageProps) => {
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <Badge className="bg-blue-600/10 text-blue-700 border-blue-600/30 mb-4">
              <Shield className="h-3 w-3 mr-1" />
              Platform Administrator
            </Badge>
            <p className="text-muted-foreground text-lg">Create your admin account</p>
          </div>

          {/* Signup Card */}
          <Card className="bg-card/80 backdrop-blur-xl border-border shadow-2xl">
            <CardHeader className="space-y-3 pb-6">
              <CardTitle className="text-2xl text-foreground text-center">Platform Admin Signup</CardTitle>
              <CardDescription className="text-muted-foreground text-center text-base">
                Get full platform access and management capabilities
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSignup} className="space-y-5">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-muted-foreground h-5 w-5 group-focus-within:text-blue-600 transition-colors" />
                    <Input
                      id="name"
                      type="text"
          ...
          {/* Role Benefits */}
          <div className="mt-8 p-4 bg-blue-50 backdrop-blur-sm rounded-lg border border-blue-200">
            <h3 className="text-foreground font-medium mb-2">Platform Administrator Benefits:</h3>
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>• Full platform access and control</li>
